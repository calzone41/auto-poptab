...
class Adafruit_VL53L0X
{
  public:
    ...
    boolean         enableDefaultSpeedRanging();
    boolean         enableLongRangeRanging();
    boolean         startRanging();
    boolean         stopRanging();
    boolean         getRangingStopStatus();
    boolean         getDataReady();
    boolean         getDataValid();
    int             getRangeMM();
    boolean         getData(VL53L0X_RangingMeasurementData_t *pdata_struct);
