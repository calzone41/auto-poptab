...
boolean Adafruit_VL53L0X::begin(uint8_t i2c_addr, boolean debug ) {
  ...
  if( VL53L0X_IMPLEMENTATION_VER_MAJOR != VERSION_REQUIRED_MAJOR ||
      ...
      //Serial.println( F( "VL53L0X ERROR NOT SUPPORTED" ) );
  ...
  //Status = VL53L0X_SetGpioConfig(pMyDevice, 0,	VL53L0X_DEVICEMODE_SINGLE_RANGING, VL53L0X_GPIOFUNCTIONALITY_OFF,	VL53L0X_INTERRUPTPOLARITY_LOW);
  Status = VL53L0X_SetGpioConfig(pMyDevice, 0,	VL53L0X_DEVICEMODE_SINGLE_RANGING, VL53L0X_GPIOFUNCTIONALITY_NEW_MEASURE_READY,	VL53L0X_INTERRUPTPOLARITY_LOW);  
...
boolean Adafruit_VL53L0X::enableContinuousRanging(){
    //VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    Status = VL53L0X_ERROR_NONE;
    
    VL53L0X_DeviceModes DeviceMode = VL53L0X_DEVICEMODE_CONTINUOUS_RANGING;
...
boolean Adafruit_VL53L0X::enableHighSpeedRanging(){
    //VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    Status = VL53L0X_ERROR_NONE;
...
boolean Adafruit_VL53L0X::enableDefaultSpeedRanging(){
    //VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    Status = VL53L0X_ERROR_NONE;
    ...
    if (Status == VL53L0X_ERROR_NONE) {
        Status = VL53L0X_SetMeasurementTimingBudgetMicroSeconds(pMyDevice, 40000);
    }
...
boolean Adafruit_VL53L0X::enableLongRangeRanging(){
    //VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    Status = VL53L0X_ERROR_NONE;
...
boolean Adafruit_VL53L0X::startRanging(){
    //VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    Status = VL53L0X_ERROR_NONE;
...
boolean Adafruit_VL53L0X::stopRanging(){
    //VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    Status = VL53L0X_ERROR_NONE;
...
boolean Adafruit_VL53L0X::getRangingStopStatus(){
    Status = VL53L0X_ERROR_NONE;
    uint32_t stop_status;
    
    Status = VL53L0X_GetStopCompletedStatus(pMyDevice, &stop_status);
...
boolean Adafruit_VL53L0X::getDataReady(){
    //VL53L0X_Error Status = VL53L0X_ERROR_NONE;
    Status = VL53L0X_ERROR_NONE;
    uint8_t DataReady = 0;
    
    Status = VL53L0X_GetMeasurementDataReady(pMyDevice, &DataReady);
    
    
    if(DataReady == 1 && Status == VL53L0X_ERROR_NONE){
        if (Status == VL53L0X_ERROR_NONE)
...
boolean Adafruit_VL53L0X::getDataValid(){
    Status = VL53L0X_ERROR_NONE;
    VL53L0X_RangingMeasurementData_t data_struct;
    
    Status = VL53L0X_GetRangingMeasurementData(pMyDevice, &data_struct);
...
int Adafruit_VL53L0X::getRangeMM(){
    Status = VL53L0X_ERROR_NONE;
    VL53L0X_RangingMeasurementData_t data_struct;
...
boolean Adafruit_VL53L0X::getData(VL53L0X_RangingMeasurementData_t *pdata_struct){
    Status = VL53L0X_ERROR_NONE;
    //VL53L0X_RangingMeasurementData_t data_struct;
    VL53L0X_DeviceModes DeviceMode;

	/* Get Current DeviceMode */
	Status = VL53L0X_GetDeviceMode(pMyDevice, &DeviceMode);
    
    if (Status == VL53L0X_ERROR_NONE && DeviceMode == VL53L0X_DEVICEMODE_SINGLE_RANGING){
		PALDevDataSet(pMyDevice, PalState, VL53L0X_STATE_IDLE);
	}
    
    Status = VL53L0X_GetRangingMeasurementData(pMyDevice, pdata_struct);
